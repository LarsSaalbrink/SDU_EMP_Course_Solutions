...
INT8U get_task_cond(int num){
    return(pot[num].condition);
}

INT8U get_task_sem(int num){
    return(pot[num].sem);
}

INT16U get_task_timer(int num){
    return(pot[num].timer);
}

INT8U get_task_state(int num){
    return(pot[num].state);
}
