...
#define MAX_TASKS	   16 //16
#define MAX_QUEUES     16 //16
#define MAX_SEMAPHORES 64 //64		// The first 2xMAX_QUEUES are reserved for the queues.
